...
feature.df <- fread(serv.dir%&%"datasets/miguel-escalada_processed_data/"%&%
  "grch38/atac_consistent_peaks.sorted.bed",header=F)
```

* single-cell directory:/well/mccarthy/users/jason/datasets/amp_cmdga_atlas/single_cell/snATAC-seq/accessible_chromatin/
* Miguel-Escalada features: /well/mccarthy/users/jason/datasets/miguel-escalada_processed_data/grch38/
Islet ATAC-seq peak file: atac_consistent_peaks.sorted.bed  

Genomic regions per viewpoint
```{r}
